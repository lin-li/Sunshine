...
import com.example.linli.sunshine.app.data.WeatherContract;
import com.example.linli.sunshine.app.data.WeatherContract.WeatherEntry;
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, valuesArray);
            }
